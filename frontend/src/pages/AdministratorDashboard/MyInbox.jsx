...
function MyInbox() {
    ...
    const fetchTabItems = async () => {
        ...
        try {
            ...
            const url = activeTab === "received"
                ? "/api/admin/conversations/inbox"
                : "/api/admin/conversations/sent";
    ...
    const openItem = async (item) => {
        ...
        try {
            // ✅ No localhost, no manual headers
            const res = await axiosInstance.get(`/api/admin/conversations/${item.id}/messages`);
    ...
    const sendConversationReply = async () => {
        ...
        try {
            // ✅ No localhost, no manual headers
            await axiosInstance.post("/api/admin/conversations", {
    ...
    const deleteConversation = async () => {
        ...
        try {
            // ✅ No localhost, no manual headers
            await axiosInstance.delete(`/api/admin/conversations/${selectedItem.id}`);
        ...
        <div className="dashboard">
            <div className="inbox-container">
                ...
                <div className="btn-container">
                    ...
                    {selectedItem && (
                        <button className="btn-delete" onClick={deleteConversation}>
                            Delete Conversation
                        </button>
                    )}
                </div>
